    ...
    <x-card>
        ...
        <form action="/login{user}" method="POST">
            ...
            <div class="sm:col-span-4">
                ...
                <div class="mt-2">
                  <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-300 sm:max-w-md">
                    <input type="password" name="password" id="password"  class="block px-2 flex-1 border-0 bg-transparent py-1.5 pl-1 text-blue-300 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="">
                  </div>
                </div>
            </div>
